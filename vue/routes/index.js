...
router.get('/login', (req, res) => {
    ...
    res.redirect(`https://discord.com/api/oauth2/authorize?client_id=${discordOAuth.client_id}&redirect_uri=${discordOAuth.redirect}&response_type=code&scope=identify%20email%20guilds%20guilds.join&prompt=none`)
})
